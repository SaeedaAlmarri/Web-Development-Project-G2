...
function initAssessmentForm(currentUser) {
    ...
    document.getElementById('course').addEventListener('change', updateDefaultTitle);
    ...
    if (type && courseSelect) {
        ...
        switch(type) {
            case 'Final Exam':
                ...
                break;
            case 'Project Phase':
                defaultTitle = `Project Phase ${nextNumber}`;
                break;
            default: {
        ...
        const isAutoGenerated = currentValue === '' || 
                              currentValue.startsWith(type) ||
                              (type === 'Project Phase' && currentValue.startsWith('Project Phase'));
...
async function handleFormSubmission(form) {
    ...
    try {
        ...
        assessmentsData = storedAssessmentsData;
...
function validateAssessment(data) {
    ...
    if (courseAssessments.some(a => a.due_date === data.dueDate)) {
